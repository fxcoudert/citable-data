...
int main() {
	...
	// Load file
    Trajectory file("../../Equilibration_zeolites_defect/CHA_0.25_strong_defect_per_cell/Movies/System_0/Framework_final.pdb");
	...
	auto trajectory_new = chemfiles::Trajectory("CHA_SI_defect_0.25_per_cell_equilibrated.cif", 'w');
