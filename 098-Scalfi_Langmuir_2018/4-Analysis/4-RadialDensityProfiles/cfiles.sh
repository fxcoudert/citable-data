...
path=/home/lscalfi/Work/8-Analysis/2-Analysis/4-RadialDensityProfiles
...
do
    ...
    do
        ...
        do
            cfiles density *.xyz -c ${box[$nt]}:${box[$nt]}:42.43:90:90:120 --topology=topology.pdb --selection="atoms: name $element" --radial=Z --max=30 -o radial_$element.dat  &
        done
        cd ..
    done
    cd ..
