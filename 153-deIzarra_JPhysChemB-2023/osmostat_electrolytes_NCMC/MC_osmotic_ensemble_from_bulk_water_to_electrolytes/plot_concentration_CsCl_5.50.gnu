...
set xrange [0:1000]
	...
	plot "ratio_5.50/Output/System_0/species_evolution.txt" using 1:(($3/(6.02*10**23))/(1000*$2*18.01528*1.6605*10**(-30)))  every 1 w l lc rgb '#dfc27d' lw 3.0 notitle 				  axis x1y1,\
