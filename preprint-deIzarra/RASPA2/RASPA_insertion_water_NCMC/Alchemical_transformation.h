...
extern REAL *ProtocolWorkStore;
extern REAL *ProtocolWorkStore_vdw;
extern REAL *ProtocolWorkStore_elec;
extern int SizeProtocolWorkStore;
...
// Manage storage of the protocolwork and write protocol work
