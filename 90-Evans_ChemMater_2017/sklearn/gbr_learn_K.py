...
X = data.drop(['k_vrh', 'g_vrh', 'uni_anis'], axis=1)
...
plt.ylabel('K$\mathregular{_{GBR}}$ / GPa')
plt.xlabel('K$\mathregular{_{DFT}}$ / GPa')



plt.savefig("crossval_K_nolog.pdf", format='pdf', bbox_inches="tight", dpi=600)
